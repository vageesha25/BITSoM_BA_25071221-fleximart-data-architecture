...
This file contains recommended safe PowerShell commands and examples for running the ETL and diagnosing common issues.
...
To capture the system policy (script in the project also does this automatically on fallback):
...
If you'd like, I can add these instructions to a `README.md` instead or create a short troubleshooting checklist file. Let me know which you prefer.